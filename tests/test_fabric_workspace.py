...
def test_refresh_deployed_items_tolerates_missing_sqlendpoint(temp_workspace_dir, valid_workspace_id, caplog):
    """Regression for #887: a newly provisioned lakehouse (e.g. Dataflow Gen2 staging lakehouse)
    with an unpopulated SQL endpoint must not abort the deployed-items refresh."""
