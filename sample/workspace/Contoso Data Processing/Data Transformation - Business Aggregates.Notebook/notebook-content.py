...
df_fact_sale = spark.read.table("contosolakehouse.fact_sale") 
df_dimension_date = spark.read.table("contosolakehouse.dimension_date")
df_dimension_city = spark.read.table("contosolakehouse.dimension_city")
df_dimension_employee = spark.read.table("contosolakehouse.dimension_employee")
...
# FROM contosolakehouse.dbo.fact_sale FS
# INNER JOIN contosolakehouse.dbo.dimension_date DD ON FS.InvoiceDateKey = DD.Date
# INNER JOIN contosolakehouse.dbo.dimension_Employee DE ON FS.SalespersonKey = DE.EmployeeKey
